...
dlp_yt="yt-dlp --no-playlist --playlist-end 1 --embed-metadata --write-info-json --embed-thumbnail --embed-subs --video-multistreams --audio-multistreams --embed-chapters -f $qual --sponsorblock-remove sponsor"
